...
# This script builds the load-generator Docker image and pushes it to a new
# Amazon ECR repository. It should be run from within the src/load-generator directory.
#
...
# Set static names
ECR_REPO_NAME="telemetry-hub-load-generator"
IMAGE_TAG="latest"
